...
Each agent has a specific role defined in [.agent/personas.md](file:///Users/user/dev/projects/nocode/foodhouseSaaS/.agent/personas.md).
- **PM**: Use them to break down requirements and manage task management.
- **Architect**: Use them to draft implementation plans.
- **Developer**: Use them for strict Red-Green-Refactor implementation.
- **UI/UX Designer**: Use them to evaluate UI layout and ensure premium aesthetics.
- **Senior Lead**: Always involve them for final code review before human notification.

## 2. Core Workflows
### Strict TDD (Red-Green-Refactor)
Follow the [tdd_flow.md](file:///Users/user/dev/projects/nocode/foodhouseSaaS/.agent/workflows/tdd_flow.md).
...
Before a task is considered "Done", the **Senior Lead** must execute the [code_review.md](file:///Users/user/dev/projects/nocode/foodhouseSaaS/.agent/workflows/code_review.md).
- This ensures that all happy, sad, and edge cases are covered.
- This ensures compliance with [docs/standards.md](file:///Users/user/dev/projects/nocode/foodhouseSaaS/docs/standards.md).
...
Always check [docs/guardrails.md](file:///Users/user/dev/projects/nocode/foodhouseSaaS/docs/guardrails.md) before implementing external integrations or handling sensitive data.
