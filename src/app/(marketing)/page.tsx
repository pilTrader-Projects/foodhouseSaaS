...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900 animate-fade-in" style={{ overflowX: 'hidden' }}>
      {/* Navigation */}
      <nav className="max-w-7xl px-6 py-8 flex-between border-b" style={{ margin: '0 auto' }}>
      ...
      {/* Hero Section */}
      <header className="max-w-7xl px-6 pt-20 pb-20 grid grid-cols-2 gap-16 items-center" style={{ margin: '0 auto' }}>
        <motion.div 
      ...
      {/* Footer */}
      <footer className="max-w-7xl px-6 py-10 text-center border-t" style={{ margin: '5rem auto 0' }}>
